                ...
                :
                    <form className="form ps-2 pe-2" onSubmit={handleSubmit}>
                        ...
                        <div className="form-group">
                            ...
                            <textarea onChange={handleChange} value={form.desc} name="desc" id="desc" rows="10" cols="50"
                                      required/>
                        </div>
                        <div className="d-flex gap-3">
                            <div className="form-group" style={{width: "80%"}}>
                                <label htmlFor="image" style={{padding: "0 6px"}}
                                    ...
                                    {
                                        form.image &&
                                        <span className="AddCourse-Reset-Image-Button" onClick={() => {
